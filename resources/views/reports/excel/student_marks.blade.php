...
<table style="border-collapse:collapse;border:1px solid #999">
    <thead>
        <tr>
            <th colspan="{{ $totals['columns_count'] ?? count($subjects) + 3 }}" style="font-weight:bold;background-color:#d0d0d0;text-align:center;border:1px solid #999">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="{{ $totals['columns_count'] ?? count($subjects) + 3 }}" style="text-align:center;color:#999;border:1px solid #999">لا توجد بيانات</td>
            </tr>
        @endforelse
    </tbody>
</table>
