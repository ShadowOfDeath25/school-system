...
use App\Http\Controllers\GradeAgeController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::prefix('/reports')->name('reports.')->group(function () {
        ...
        Route::prefix('/students')->middleware('authorization:view student-reports')->name('students.')->group(function () {
            ...
            Route::get('certificates/components', [CertificateController::class, 'components'])->name('certificates.components')->middleware('authorization:view student-reports');
            ...
            Route::get('id-cards', [StudentReportController::class, 'idCards'])->name('id-cards')->middleware('authorization:view student-reports');
    ...
    Route::middleware(['authorization'])->group(function () {
        ...
        Route::get('students/{student}/parent-payments', [StudentController::class, 'getParentPayments']);
